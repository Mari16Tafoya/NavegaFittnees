...
class HomeRepositoryImpl(
    ...
    override suspend fun getTravelGuide(
        ...
        return try {
            var places = ""
            if (settings.gimnasios) places += "Gimnasios, "
            if (settings.centros) places += "Centros, "
            ...
            val request = ChatRequestDto(
                ...
                prompt = "Soy un guía de viaje. Te voy a dar mi ubicación, y me vas a sugerir lugares para visitar cerca. También te voy a dar los tipos de lugares que quiero visitar. Aparte, quiero que me sugieras lugares de un tipo similar a los que te mencione que estén cerca de mi primera ubicación. Estoy en $location y quiero visitar: Gimnasios y centros de nutrición. Dame la ubicación de cada lugar. Ordénalos por tipo de lugar.",
                temperature = 0.7
            )
